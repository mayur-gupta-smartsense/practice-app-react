export default function ShoppingCart() {
    return (
        <div className="w-full bg-white dark:bg-[#0A2025] py-9 px-8">
            ...
            <div className="flex items-start mt-8 gap-6">
                            ...
                            <tr className="text-center">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        ></path></svg><span
                                        className="w-10 text-center text-[#191919] text-base font-normal leading-normal">5</span><svg
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            stroke-linejoin="round"
                                        ></path></svg><span
                                        className="w-10 text-center text-[#191919] text-base font-normal leading-normal">5</span
                                    ><svg
                                        className="cursor-pointer relative"
                                        width="14"
                                        height="15"
                ...
                <div className="w-[424px] bg-white rounded-lg p-6">
                    ...
                    <div className="w-[376px] py-3 justify-between items-center flex">
                        ...
                        >Total:</span><span className="text-[#191919] text-base font-semibold leading-tight"
                        >$84.00</span>
                    </div>
                    <div
                        className="w-[376px] py-3 shadow-[0px_1px_0px_0px_rgba(229,229,229,1.00)] justify-between items-center flex"
                    >
                        <span className="text-[#4c4c4c] text-sm font-normal leading-[21px]">Shipping:</span><span className="text-[#191919] text-sm font-medium leading-[21px]"
                        >Free</span>
                    </div>
                    <div
                        className="w-[376px] py-3 shadow-[0px_1px_0px_0px_rgba(229,229,229,1.00)] justify-between items-center flex">
                        <span className="text-[#4c4c4c] text-sm font-normal leading-[21px]"
                        >Subtotal:</span><span className="text-[#191919] text-sm font-medium leading-[21px]"
                        >$84.00</span>
                    </div>
                    <button
            ...
            >
                <h3
                    className="text-[#191919] w-1/4 text-xl font-medium leading-[30px]"
                >
                    Coupon Code
                </h3>
